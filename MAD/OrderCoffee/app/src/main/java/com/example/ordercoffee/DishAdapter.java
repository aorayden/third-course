...
public class DishAdapter extends ArrayAdapter<String> {
    ...
    public DishAdapter(Context context, String[] names, TypedArray images) {
    ...
    private View createView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView = view.findViewById(R.id.dishText);
        ImageView imageView = view.findViewById(R.id.dishImage);
